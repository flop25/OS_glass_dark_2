<?php
/*
Theme Name: OS_glass_dark_2
Version: auto
Description: 
Theme URI: http://piwigo.org/ext/extension_view.php?eid=516
Author: flop25
Author URI: http://www.planete-flop.fr
*/

$themeconf = array(
  'name'         => 'OS_glass_dark_2',
  'parent'        => 'OS_default',
...
{
  @include(PHPWG_ROOT_PATH.PWG_LOCAL_DIR. 'config/OS_glass_dark_2.inc.php');
}
